...
Build and push AI Chatbot Docker image to Gitea OCI registry.
...
Options:
  ...
  --skip-build            Skip pnpm build, only build Docker image
...
echo "============================================"
echo "Build and Push AI Chatbot"
echo "============================================"
