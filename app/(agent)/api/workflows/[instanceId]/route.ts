...
export async function GET(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    // 404 - try workflow-patterns
    console.log(`[Workflow Detail] Not found in orchestrator, trying workflow-patterns`);
  } catch (error) {
    // Connection error to orchestrator - still try patterns
    console.log(`[Workflow Detail] Orchestrator unavailable, trying workflow-patterns`);
  }
