{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/vpittamp/repos/PittampalliOrg/ai/main";
  project_input_ref = "path:/home/vpittamp/repos/PittampalliOrg/ai/main";
  devenv_dotfile = "/home/vpittamp/repos/PittampalliOrg/ai/main/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-94dafa4";
