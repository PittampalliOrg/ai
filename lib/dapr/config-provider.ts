...
const CONFIG_KEYS = [
  ...
  "PLANNER_DAPR_AGENT_APP_ID",
  "PLANNER_DAPR_AGENT_URL",
  "PLANNER_DAPR_AGENT_SERVICE_URL",
  ...
  "WORKFLOW_ORCHESTRATOR_APP_ID",
  "USE_WORKFLOW_ORCHESTRATOR",
...
const SECRET_MAPPINGS: Record<string, string> = {
  ...
  WORKFLOW_BUILDER_INTERNAL_API_TOKEN: "INTERNAL-API-TOKEN",
  // Database
